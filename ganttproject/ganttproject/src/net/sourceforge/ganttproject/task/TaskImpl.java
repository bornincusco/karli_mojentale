...
public class TaskImpl implements Task {
  ...
  private class MutatorImpl implements TaskMutator {
    ...
    private FieldChange isDynamicChange;
    /** */
    ...
    public void commit() {
      try {
        ...
        if (isDynamicChange != null) {
          boolean isDynamic = isDynamic();
          TaskImpl.this.setDynamic(isDynamic);
        }
        /** */
    ...
    boolean isDynamic() {
      return isDynamicChange == null ? TaskImpl.this.isDynamic : (boolean) isDynamicChange.myFieldValue;
    }
    int getWorkload(){
      return myWorkloadChange == null ? TaskImpl.this.myWorkload : (int) myWorkloadChange.myFieldValue;
    }
